<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="BurgerShop.Register1" %>
...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <style>
        body#LoginForm{ background-image:url("https://www.wallpaperup.com/uploads/wallpapers/2017/10/17/1113328/c8f1c635f8f2120003ba560b97f4d38a-700.jpg"); background-repeat:no-repeat; background-position:center; background-size:cover; padding:10px;}
...
<div class="main-div">
   ...
   <p>Enter your details</p>
    ...
    <form id="Login">
        ...
        <asp:Label ID="Label2" runat="server" Text="Name"  Font-Size="Medium" ForeColor="black"></asp:Label>
       
            <br />
       
            <asp:TextBox class="form-control" ID="NameBurger" runat="server"   BorderStyle="None" Height="20px"></asp:TextBox>
